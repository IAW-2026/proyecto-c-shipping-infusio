      ...
      <div className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-5xl items-center">
        <div className="relative w-full overflow-hidden rounded-4xl border border-border bg-card px-6 py-10 shadow-[0_20px_80px_rgba(45,41,38,0.12)] sm:px-10 sm:py-14">
          ...
          <div className="relative grid gap-8 items-center text-center">
            <div>
              <p className="mb-4 text-sm uppercase tracking-widest text-primary font-medium">Error de autenticación</p>
              <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-foreground">Iniciar sesión</h1>
              <p className="mt-4 max-w-xl mx-auto text-muted-foreground">Lo sentimos — para acceder a este sitio debés iniciar sesión.</p>
